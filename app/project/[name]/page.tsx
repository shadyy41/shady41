    ...
    <main className="w-full text-zinc-300 flex flex-col items-center gap-5 mb-6">
      <div className="w-full p-4 sm:px-0 max-w-2xl flex flex-col gap-6">
        ...
        <div className="w-full max-w-2xl flex flex-col">
          <h1>
            <a href={project.url} className="hover:text-white text-zinc-100 transition-colors w-fit font-semibold text-2xl"  target="_blank" rel="noopener noreferrer">{ project.name }</a>
          </h1>
          <div className="flex gap-2 text-sm">
            { project.gh && <a className="hover:text-white transition-colors w-fit underline decoration-yellow-500 decoration-2" target="_blank" rel="noopener noreferrer" href={ project.gh }>Repo</a> }
        ...
        <div className="w-full max-w-2xl flex flex-col">
          <h2 className="font-semibold items-center flex gap-1 text-2xl text-zinc-100"><span className="text-yellow-500">#</span>Description</h2>
          <p className="text-lg">
            { project.description }
          </p>
        </div>
        <div className="w-full max-w-2xl flex flex-col">
          <h2 className="font-semibold items-center flex gap-1 text-2xl text-zinc-100"><span className="text-yellow-500">#</span>Tech Stack</h2>
