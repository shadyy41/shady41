...
const classes_array = ["bg-red-500", "bg-green-500", "bg-purple-500", "bg-pink-500"]

export default function Home() {
  return (
    <main className="w-full text-zinc-200 flex flex-col items-center gap-5 p-4 pb-6">
      <header className="w-full flex justify-between items-center max-w-2xl text-sm">
      ...
      <div className="w-full max-w-2xl flex flex-col gap-2">
        ...
        <p className="text-lg text-neutral-950 shadow-[5px_5px_0px_0px_#5050507a] p-2 bg-yellow-500 rounded-md">I am a fullstack web developer and an engineering undergrad at NSUT, Delhi. I like building web apps with Nextjs and Tailwind, currently I am learning Rust and tRPC.</p>
      </div>
      <div className="w-full max-w-2xl flex flex-col gap-2">
      ...
      <div className="w-full max-w-2xl flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1 text-lg text-neutral-950 shadow-[5px_5px_0px_0px_#5050507a] p-2 bg-blue-500 rounded-md">
